...
import (
	...
	"github.com/sam-laister/tiktok-creator/ent/migrate"
...
func (c *ClipClient) mutate(ctx context.Context, m *ClipMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown Clip mutation op: %q", m.Op())
	}
}
